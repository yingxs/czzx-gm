...
var springrain = {
	...
	loadProgressBar : function(){
		...
		$('#springrain-loadimg').css({'position':'absolute','background':'url(${ctx}/static/images/loaderc.gif) no-repeat center center','z-index':88888889,'width':'100px','height':'100px','left':(w-100)/2,'top':((h-100)/2)-30}).find('span').css({'position':'absolute','left':0,'bottom':'-40px','width':110,'display':'block','height':40,'text-align':'center'});
	},
	//关闭进度条
